...
Sample Bot using the JavaScript SDK for Bot Framework v4 that integrates with Speech to Text services.
...
- Install modules
    ...
    npm install
    ```
- Add appropriate values to your `.env` file for the keys below
    - MicrosoftAppId=
